...
$lang->load('com_realpin', JPATH_ADMINISTRATOR);
...
function getglobal($state)
{
	...
	if(version_compare(JVERSION,'1.6.0','ge'))
	{
		...
		if($state=="false")
		$result="administrator/templates/bluestork/images/admin/publish_x.png";
		if($state=="true")
		$result="administrator/templates/bluestork/images/admin/tick.png";
	} 
	else
	{
		// Joomla! 1.5 code here
		if($state=="false")
		$result="administrator/images/publish_x.png";
		if($state=="true")
		$result="administrator/images/tick.png";
	}
...
$doc = JFactory::getDocument();
	...
	$doc->addStyleSheet(JURI::root().'administrator/templates/bluestork/css/template.css');
	}
	else 
	{
	$doc->addStyleSheet(JURI::root().'administrator/templates/khepri/css/general.css');
	}
...
<img style="float:left;outline:none" border="0" alt="Freigegeben" src="<?php echo getglobal($globalvar);?>"></a><?php }; ?>
...
<?php if(visible(ENABLE_POSTIT_GLOBAL) or visible(ENABLE_YT_GLOBAL) or visible(ENABLE_PIC_GLOBAL))
    { ?> 
            ...
            <?php if(visible(ENABLE_POSTIT_GLOBAL) and ISGLOBAL=="true"){ ?> 
              ...
              <img border="0" alt="Freigegeben" src="<?php echo getglobal(ENABLE_POSTIT_GLOBAL);?>"></a>
            <?php } if(visible(ENABLE_YT_GLOBAL) and ISGLOBAL=="true"){ ?> 
              ...
              <img border="0" alt="Freigegeben" src="<?php echo getglobal(ENABLE_YT_GLOBAL);?>"></a>
            <?php } if(visible(ENABLE_PIC_GLOBAL) and ISGLOBAL=="true"){ ?> 
              ...
              <img border="0" alt="Freigegeben" src="<?php echo getglobal(ENABLE_PIC_GLOBAL);?>"></a>
